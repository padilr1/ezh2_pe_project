...
```
### Relationship b/w EZH2-PE Inclusion & EZH2 Expression

```{r, echo=FALSE,warning=FALSE, message=FALSE,fig.cap="Figure 3. Increasing EZH2-PE inclusion coincides with decreasing EZH2 expression. Data from Burke et al. 2020"}
df_burke_2020_expressionANDpsi %>%
  ...
  labs(title = "EZH2-PE",x="logPSI",y="Normalized EZH2 Expression") +
  theme(plot.title = element_text(hjust = 0.5,vjust = 2.5),
        axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
```
```{r, echo = FALSE,message= FALSE, warning=FALSE,fig.cap="Figure 5. EZH2-PE inclusion increases while EZH2 expression decreases across time in human cerebellum. Data from Cardoso et al. 2019"}
...
complete_cardoso2019_hsapien_hindbrain_PE %>%
  ...
  labs(title = "EZH2-PE",x="logPSI",y="Normalized EZH2 Expression (RPKM)") +
  theme(plot.title = element_text(hjust = 0.5,vjust = 2.5),
        axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
